#!/usr/bin/env python3
"""
Generate V10 Spreadsheet - Ripple/Cascade Rebalancing Algorithm
...
Fixed: Uses Voter_Coun from geographic file as fallback for newer precincts not in 2022 data.
"""
...
def generate_v10_files():
    """Generate all V10 CSV files."""
    print("="*60)
    print("GENERATING V10 SPREADSHEET FILES - RIPPLE/CASCADE ALGORITHM")
    print("="*60)
    
    # Create v10 directory
    V10_DIR.mkdir(exist_ok=True)
    print(f"\nOutput directory: {V10_DIR}")
    ...
    precinct_dist.to_csv(V10_DIR / "VSPC - Precinct Distribution.csv", index=False)
    ...
    summary.to_csv(V10_DIR / "VSPC Summary.csv", index=False)
    
    print(f"\n✅ V10 files generated in {V10_DIR}")
