#!/usr/bin/env python3
"""
Generate V14 Spreadsheet - Ripple/Cascade Rebalancing Algorithm
...
Based on v11, copied to v14 for modifications.
"""
...
def generate_v14_files():
    """Generate all V14 CSV files."""
    print("="*60)
    print("GENERATING V14 SPREADSHEET FILES - RIPPLE/CASCADE ALGORITHM")
    print("="*60)
    
    # Create v14 directory
    V14_DIR.mkdir(exist_ok=True)
    print(f"\nOutput directory: {V14_DIR}")
    ...
    precinct_dist.to_csv(V14_DIR / "VSPC - Precinct Distribution.csv", index=False)
    ...
    summary.to_csv(V14_DIR / "VSPC Locations.csv", index=False)
    ...
    stats_df.to_csv(V14_DIR / "Summary Statistics.csv", index=False)
    
    print(f"\n✅ V14 files generated in {V14_DIR}")
